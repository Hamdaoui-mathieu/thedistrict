...
try {
      $requete = $db->prepare("INSERT INTO plat (libelle, description, prix, id_categorie, active, image) VALUES (:libelle, :description, :prix, :id_cat, :active, :picture);");
